...
switch eventformat
  ...
  case {'neuromag_fif_v2' 'neuromag_mne_v2' 'neuromag_mex_v2' 'neuromag_fif_v2_flipped' 'neuromag_mne_v2_flipped' 'neuromag_mex_v2_flipped'}
    errmsg = sprintf(['Using the ''v2'' event formats is not supported anymore.\nThe features have been incooporated into the latest fieldtrip version.\n\n' ...
      'Please adjust your code according to the following cases:\n' ...
      '1. If you have used "neuromag_fif_v2", "neuromag_mne_v2" or "neuromag_mex_v2", just delete the "_v2" part and you are fine.\n' ...
